...
(function(){
  ...
  Class.extend = function(prop) {
	...
	this.Programmer = Person.extend( {
		speak: function () {
			return this._super() + ' and writes some code';
		}
	});
	...
	console.log(myProgrammer instanceof Programmer);
	console.log(myProgrammer instanceof Person);
